    ...
    async updateInfo(): Promise<any> {
        ...
        try {
            const [config, zip] = await axios.all([
                axios.get("https://raw.githubusercontent.com/Jelosus2/auuto-update-test/main/info.json", lOptions),
                axios.get("https://raw.githubusercontent.com/Jelosus2/auuto-update-test/main/content.zip", zOptions),
            ]);
