...
/**
 * A class for requesting Genshin info to the Enka API.
 */
export class GenshinClient {
  ...
  /**
   * Returns the data of a Genshin player by the given UID.
   * @param uid - The UID of the player to get the data.
   * @param language - The language to get the names.
   * @returns The data of the Genshin player.
   */
  async getPlayer(
    uid: string | number,
  ...
  /**
   * Returns the data of the Genshin hoyos of an Enka profile by the given username.
   * @param username - The username of the profile to get the data.
   * @param language - The language to get the names.
   * @returns The data of the profile Genshin hoyos.
   */
  async getEnkaHoyos(
    username: string,
    language: string = this.language
  ...
  /**
   * Returns the Genshin builds of an Enka hoyo by the given username and profile hash.
   * @param username - The username of the profile to get the data.
   * @param hash - The hash of the Genshin hoyo to get the builds.
   * @param language - The language to get the names.
   * @returns The Genshin builds of the profile.
   */
  ...
  parseSubstats(
    ...
    return substatsIds.map(
      (substatId) =>
        new Substats(substatId, language as AssetFinderOptions["language"])
    );
  }
}